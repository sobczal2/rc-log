...
use rc_log_application::{shared::validator::ValidationError, user::sign_up::error::SignUpError};
...
impl From<SignUpError> for Error {
    fn from(e: SignUpError) -> Self {
        match e {
            ...
            SignUpError::Validation(msg) => Self::Validation(msg),
...
impl IntoResponse for Error {
    fn into_response(self) -> Response {
        match self {
            ...
            Error::EmailTaken => ApiError::conflict(self.to_string()).into_response(),

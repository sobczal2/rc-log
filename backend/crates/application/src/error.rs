...
use crate::session::delete::error::DeleteSessionError;
...
use crate::session::update_performed_variation::error::UpdatePerformedVariationError;
...
pub enum ApplicationError {
    ...
    #[error(transparent)]
    DeleteSession(#[from] DeleteSessionError),
    #[error(transparent)]
    ...
    #[error(transparent)]
    UpdatePerformedVariation(#[from] UpdatePerformedVariationError),
    #[error(transparent)]
